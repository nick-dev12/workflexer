...
<head>
    ...
    <meta property="og:description"
        content="<?php echo $users['competences']; ?> expérimenté(e) en recherche active. Découvrez le profil complet de <?php echo $users['nom']; ?> sur Work-Flexer.">
    ...
    <meta name="twitter:description"
        content="<?php echo $users['nom']; ?> - <?php echo $users['competences']; ?> recherche activement de nouvelles opportunités professionnelles. Découvrez mon profil complet sur Work-Flexer.">
...
<body>
                    ...
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        if (textarea) {
                            ...
                            textarea.addEventListener("keyup", () => {
                                const nombreCaracteres = textarea.value.length;
                                if (caracteresRestants) {
                                    caracteresRestants.textContent =
                                        `${400 - nombreCaracteres} caractères restants`;
                                }
                            });
                        ...
                        if (textareaAdd) {
                            ...
                            if (caracteresRestantesAdd) {
                                caracteresRestantesAdd.textContent =
                                    `${400 - nombreCaracteresAdd} caractères restants`;
                            }
                ...
                <?php else: ?>
                    <?php if (isset($_SESSION['users_id'])): ?>
                        ...
                        <div class="highlight-instructions">
                            <p><i class="fas fa-info-circle"></i> Tapez sur une expérience pour la sélectionner/désélectionner.
                                Les expériences sélectionnées apparaîtront en vert.</p>
                    ...
                    <div class="experiences-list">
                        <?php foreach ($afficheMetier as $metiers): ?>
                            <div class="experience-card <?php echo ($metiers['mis_en_avant'] == 1) ? 'highlighted' : ''; ?>"
                                data-id="<?php echo $metiers['id']; ?>">
                            ...
                            document.addEventListener("DOMContentLoaded", function () {
                                ...
                                document.querySelectorAll("[id^='imgs2-']").forEach(button => {
                                    button.addEventListener("click", function () {
                                        ...
                                        form_modif.style.display = (form_modif.style.display ===
                                            "none" || form_modif.style.display === "") ? "block" :
                                            "none";
                                    });
                                });
                                ...
                                document.querySelectorAll("textarea[id^='description-']").forEach(textarea => {
                                    const caractere_id = document.getElementById("caractere-" + textarea.id
                                        .split('-')[1]);
                                    textarea.addEventListener("input", () => {
                                        const nombre = textarea.value.length;
                                        caractere_id.textContent =
                                            `${300 - nombre} caractères restants`;
                                        if (nombre > 300) {
            ...
            <div class="box3" id="competences-section">
                ...
                <?php if (isset($_SESSION['users_id'])): ?>
                    ...
                    <div class="competence-highlight-instructions">
                        <p><i class="fas fa-info-circle"></i> Tapez sur une compétence pour la sélectionner/désélectionner.
                            Les compétences sélectionnées apparaîtront en vert.</p>
                ...
                <div class="container_comp">
                    ...
                    <?php else: ?>
                        ...
                        foreach ($competencesUtilisateur as $competence):
                            ?>
                            <p class="comp <?php echo ($competence['mis_en_avant'] == 1) ? 'highlighted' : ''; ?>"
                                data-id="<?php echo $competence['id']; ?>">
                ...
                <?php else: ?>
                    <?php if (isset($_SESSION['users_id'])): ?>
                        ...
                        <div class="formation-highlight-instructions">
                            <p><i class="fas fa-info-circle"></i> Tapez sur une formation pour la sélectionner/désélectionner.
                                Les formations sélectionnées apparaîtront en vert.</p>
                    ...
                    <div class="formations-list">
                        <?php foreach ($formationUsers as $formations): ?>
                            <div class="formation-card <?php echo ($formations['mis_en_avant'] == 1) ? 'highlighted' : ''; ?>"
                                data-id="<?php echo $formations['id']; ?>">
                                ...
                                <script>
                                    document.querySelector('.edit-btn[data-formation-id="<?php echo $formations['id']; ?>"]')
                                        .addEventListener('click', function () {
                                            document.getElementById('edit-form-<?php echo $formations['id']; ?>').style
                                                .display = 'block';
                                        });

                                    document.querySelector('#edit-form-<?php echo $formations['id']; ?> .close-edit-form')
                                        .addEventListener('click', function () {
                                            document.getElementById('edit-form-<?php echo $formations['id']; ?>').style
                                                .display = 'none';
                                        });
                    ...
                    <div class="container_box">
                        <div class="box1">
                            ...
                            <select name="niveau" id="niveau_etude">
                                ...
                                <option value="DEUST">DEUST (Diplôme d'Études Universitaires Scientifiques et
                                    Techniques)</option>
                ...
                <?php else: ?>
                    ...
                    <div class="tools-list">
                        ...
                        <?php foreach ($afficheOutil as $outils): ?>
                            <div class="tool-item <?php echo ($outils['mis_en_avant'] == 1) ? 'highlighted' : ''; ?>"
                                data-id="<?php echo $outils['id'] ?>">
                                <div class="tool-info">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const afficherFormsButtons = document.querySelectorAll(
                '.section3 .container_box2 .box3 .affiche_forms, .section3 .container_box2 .box3 .affiche_formss'
            );
