...
if (isset($_POST['recherche'])) {
    $_SESSION['criteres_emploi_senegal'] = [
        'search' => $recherche
    ];
    // Rediriger vers la page de résultats spécifique à EmploiSenegal
    header('Location: resultats_emploi_senegal.php?page=1');
    exit();
} elseif (isset($_SESSION['criteres_emploi_senegal']) && !isset($_GET['reset'])) {
    ...
    $recherche = $_SESSION['criteres_emploi_senegal']['search'];
}
...
try {
    ...
    error_log("Erreur lors de l'exécution de la requête EmploiSenegal: " . $e->getMessage());
    $offres = [];
}

// Comptage du nombre total d'offres pour la pagination
$sqlCount = "SELECT COUNT(*) FROM scrap_emploi_emploisenegal WHERE 1=1";
$countParams = [];
...
try {
    ...
    error_log("Erreur lors du comptage des résultats EmploiSenegal: " . $e->getMessage());
    $totalOffres = 0;
}
...
<head>
    ...
    <meta name="description"
        content="Consultez les offres d'emploi d'EmploiSenegal sur Work-Flexer. Trouvez le poste qui correspond à vos compétences et ambitions.">
    <title>Offres d'emploi EmploiSenegal | WorkFlexer</title>
...
<body>
    ...
    <section class="hero-search-section">
        <div class="slider">
            <div class="box">
                ...
                <div class="text">
                    <h1>Offres d'emploi d'EmploiSenegal</h1>
                    <p>Découvrez les dernières opportunités d'emploi de la plateforme EmploiSenegal</p>
    ...
    <div class="job-stats-container">
        <div class="job-stats">
            ...
            <div class="stat-item">
                ...
                <span class="count">
                    <?php echo $db->query("SELECT COUNT(DISTINCT entreprise) FROM scrap_emploi_emploisenegal")->fetchColumn(); ?>
                </span>
            ...
            <div class="stat-item">
                ...
                <span class="count">
                    <?php echo $db->query("SELECT COUNT(DISTINCT localisation) FROM scrap_emploi_emploisenegal")->fetchColumn(); ?>
                </span>
    ...
    <h1 class="titre_emploi">Offres d'emploi sur EmploiSenegal</h1>
    ...
    <section class="tous_les_offres">
                        ...
                        <div class="info-box">
                            <div class="header">
                                ...
                                <span class="date"><i class="far fa-calendar-alt"></i>
                                    <?php echo $offre['date_publication']; ?>
                                </span>
                            </div>
                            <h2 class="poste">
        ...
        <div class="pagination-container">
            <p class="pagination-info">Page
                <?php echo $pageActuelle; ?> sur
                <?php echo $totalPages; ?>
            </p>
