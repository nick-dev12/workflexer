...
<head>
    ...
    <meta name="description"
        content="Consultez les offres d'emploi de SenJob sur Work-Flexer. Trouvez le poste qui correspond à vos compétences et ambitions.">
    <title>Offres d'emploi SenJob | WorkFlexer</title>
    ...
    <section class="hero-search-section">
        <div class="slider">
            <div class="box">
                ...
                <div class="text">
                    <h1>Offres d'emploi de SenJob</h1>
                    <p>Découvrez les dernières opportunités d'emploi de la plateforme SenJob</p>
                ...
                <?php foreach ($offres as $offre): ?>
                    ...
                    <div class="job-card-new" data-type="<?php echo strtolower($offre['type_contrat']); ?>">
                        ...
                        <div class="card-footer">
                            <a href="/page/emploi_details3.php?id=<?php echo $offre['offre_id']; ?>"
