...
<body>
    ...
    <div class="slider-area owl-carousel" data-aos="zoom-in">
        <div class="slider-item">
            <img src="/image/orientation1.png" alt="">
            <div class="box">
                <h1 data-aos="fade-up"> Explorez les Horizons de Carrière Passionnants</h1>
                <p data-aos="fade-up">
                    Explorez notre catalogue diversifié de formations conçues pour répondre à une multitude d'intérêts
                    et d'objectifs. Que vous soyez passionné par les sciences, les arts, la technologie ou les affaires,
                    nous avons les programmes éducatifs adaptés à vos besoins. Nos cours sont dispensés par des
                    professionnels expérimentés et sont conçus pour vous préparer à réussir dans votre domaine d'études
                    choisi. Plongez dans l'apprentissage avec nous et ouvrez la porte à un avenir prometteur.
                </p>
        ...
        <div class="slider-item">
            <img src="/image/orientation2.png" alt="">
            <div class="box">
                <h1>Explorez les Débouchés et les Opportunités de Carrière</h1>
                <p>
                    Découvrez une multitude de débouchés et d'opportunités de carrière passionnantes dans une variété de
                    secteurs d'activité. Que vous soyez intéressé par les carrières traditionnelles ou les nouvelles
                    tendances de l'emploi, notre plate-forme offre une vue d'ensemble complète des possibilités
                    professionnelles qui s'offrent à vous. Explorez les différents chemins de carrière, des postes
                    d'entrée de gamme aux postes de direction, et découvrez comment vous pouvez atteindre vos objectifs
                    professionnels grâce à nos ressources et notre expertise.
                </p>
        ...
        <div class="slider-item">
            <img src="/image/orientation3.png" alt="">
            <div class="box">
                <h1>Explorez les Perspectives de Carrière Émergentes</h1>
                <p>
                    Plongez dans le futur de l'emploi en explorant les perspectives de carrière émergentes dans des
                    domaines en pleine croissance tels que l'intelligence artificielle, la cybersécurité, la durabilité
                    environnementale, et bien plus encore. Notre plate-forme met en lumière les tendances du marché du
                    travail et vous guide vers des opportunités professionnelles prometteuses qui répondent aux besoins
                    évolutifs de l'économie mondiale. Préparez-vous à embrasser le changement et à saisir les
                    opportunités offertes par les industries de demain.
                </p>
    ...
    <section class="section3">
        <div class="container">
            <h1>métier formation et déboucher dans le domaine de la santé</h1>

            <p class="p">
                La catégorie de la santé et de la médecine regroupe un ensemble de professions dédiées à la
                préservation, au rétablissement et à l'amélioration de la santé des individus. Les professionnels de ce
                domaine travaillent dans divers environnements, tels que les hôpitaux, les cliniques, les cabinets
                médicaux et les centres de recherche. Leurs rôles peuvent inclure la fourniture de soins directs aux
                patients, la recherche médicale, la gestion des soins de santé et la promotion de la santé publique.
            </p>
            ...
            <div class="box owl-carousel box01">
                <div class="item">
                    ...
                    <p>
                        ...
                        médicale, administrer des traitements et des médicaments, surveiller l'état de santé des
                        patients, fournir un soutien émotionnel et éducatif aux patients et à leur famille.<br>
                        <strong>Moyens :</strong> Obtenez un diplôme d'infirmier (DEI ou BSN) dans une école de soins
                        infirmiers agréée, réussissez l'examen d'agrément, effectuez des stages cliniques pratiques dans
                        divers établissements de santé, obtenez des certifications supplémentaires selon les spécialités
                        désirées, poursuivez des formations continues pour rester à jour dans le domaine médical.
                    </p>
                </div>
