...
// Vérifier si des critères de recherche existent pour EmploiSenegal
if (!isset($_SESSION['criteres_emploi_senegal'])) {
    header('Location: offres_emploi_senegal.php');
    exit();
}
...
<head>
    ...
    <meta name="description" content="Résultats de recherche pour les offres d'EmploiSenegal sur Work-Flexer.">
    <title>Résultats de recherche - EmploiSenegal | WorkFlexer</title>
...
<body>
    ...
    <div class="results-header">
        <div class="container">
            <h1>Résultats de recherche - EmploiSenegal</h1>
            ...
            <div class="actions">
                <a href="offres_emploi_senegal.php?reset=1" class="btn-new-search">Nouvelle recherche</a>
                <a href="offres_emploi_senegal.php" class="btn-all-jobs">Voir toutes les offres</a>
            </div>
