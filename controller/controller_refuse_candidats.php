...
<body>
    <div class='email-container'>
        ...
        <div class='email-body'>
            ...
            <p class='email-text'>Nous vous remercions pour l'intérêt que vous avez porté à ce poste et pour le temps
                que vous avez consacré à votre candidature.</p>

            <p class='email-text'>Après étude attentive de votre profil, nous sommes au regret de vous informer que
                votre candidature n'a pas été retenue pour ce poste.</p>

            <p class='email-text'>Nous vous encourageons à continuer votre recherche sur notre plateforme, où de
                nombreuses autres opportunités correspondant à votre profil sont disponibles.</p>

            <a href='https://work-flexer.com/page/user_profil.php' class='button'>Découvrir d'autres opportunités</a>

            <p class='note'>Nous vous souhaitons beaucoup de succès dans votre recherche d'emploi et espérons vous
                revoir bientôt sur Work-Flexer.</p>
