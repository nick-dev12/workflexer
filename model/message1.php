...
function post_TMPMessage1($db, $entreprise_id, $users_id, $offre_id, $statut, $messages, $indicatif, $date)
{
    $sql = "INSERT INTO tmp_message1 (entreprise_id,users_id,offre_id,statut,messages,indicatif ,date)
VALUES (:entreprise_id,:users_id,:offre_id,:statut,:messages,:indicatif,:date)";
    $stmt = $db->prepare($sql);
    $stmt->bindParam(":entreprise_id", $entreprise_id, );
    $stmt->bindParam(":users_id", $users_id, );
