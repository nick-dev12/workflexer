      ...
      <body>
          <div class='email-container'>
              ...
              <div class='email-body'>
                  ...
                  <div class='email-title'>Confirmation de votre compte</div>
                  <p class='email-text'>Merci d'avoir créé un compte sur Work-Flexer. Pour activer votre compte et accéder à toutes nos fonctionnalités, veuillez utiliser le code de vérification ci-dessous.</p>
                  
                  <div class='verification-code'>$verification</div>
                  
                  <p class='email-text'>Saisissez ce code sur la page de vérification pour finaliser la création de votre compte.</p>
                  
                  <p class='email-text'>Avec Work-Flexer, vous pourrez :</p>
                  <ul style='margin-left: 20px; margin-bottom: 20px; color: #555555;'>
                      <li style='margin-bottom: 8px;'>Créer un profil professionnel attractif</li>
                      <li style='margin-bottom: 8px;'>Postuler à des offres d'emploi correspondant à vos compétences</li>
                      <li style='margin-bottom: 8px;'>Être contacté directement par des recruteurs</li>
                      <li style='margin-bottom: 8px;'>Suivre vos candidatures en temps réel</li>
                  </ul>
                  
                  <p class='note'>Si vous n'avez pas créé de compte sur Work-Flexer, veuillez ignorer cet e-mail.</p>
      ...
      <div class="login-form-container">
        ...
        <form method="post" action="" class="login-form">
          <div class="form-group">
            ...
            <input type="text" name="code" id="code" class="form-input" placeholder="Entrez le code reçu par e-mail">
          </div>
