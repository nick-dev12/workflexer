    ...
    <section class="section3">
        ...
        <div class="container_box2">
            <div class="box1">
                ...
                <span>
                    <?php
                    $countOffre = countOffreExpirees($db, $_SESSION['compte_entreprise']);
                    echo $countOffre
                        ?>
                </span>
            </div>
            ...
            <div class="categories-grid">
                ...
                <?php else: ?>
                    <?php foreach ($categorie_entreprise as $categorie):
                        ...
                        $offres_categorie = getOffreExpiree($db, $_SESSION['compte_entreprise'], $categorie['categori']);
                        ...
                        if ($countOffreCategorie > 0):
                            ...
                            <a href="/entreprise/offres_expirer_categorie.php?pageExpireeCategorie=<?= urlencode($categorie['categori']) ?>"
                                class="category-card">
