   ...
   <div class="containers">
        ...
        <div class="box1">
            ...
            <?php if (empty($descriptions)): ?>
                            <p class="a_propos">Aucune donnée trouver</p>
                        <?php else: ?>
                            <p class="a_propos">
        ...
        <div class="box2">
            <div class="item1">
                ...
                <div class="exp">
                    <h2>Experience Professionnelles <img src="/image/experience.png" alt=""></h2>
                    ...
                    <div class="box">
                        ...
                        <div>
                        <span> <?= $Metiers['moisDebut'] ?> /<?= $Metiers['anneeDebut'] ?> au  <?= $Metiers['moisFin'] ?> /<?= $Metiers['anneeFin'] ?> </span>
                ...
                <div class="educ">
                    <h2>Education <img src="/image/etude.png" alt=""></h2>
                   <div class="box">
                   <?php if (empty($formationUsers)): ?>
                    ...
                    <div>
                    <span> <?= $formations['moisDebut'] ?> /<?= $formations['anneeDebut'] ?> au  <?= $formations['moisFin'] ?> /<?= $formations['anneeFin'] ?> </span>
            ...
            <div class="item2">
                ...
                <?php if ($afficheOutil): ?>
                    ...
                    <div id="compe">
                     <h2>Competences <img src="/image/compétences.png" alt=""></h2>
                     <ul> 
