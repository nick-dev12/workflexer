...
html2pdf().set(mergedOptions).from(element).save("cv.pdf");
   ...
   <div class="containers">
        ...
        <div class="box2">
            ...
            <div class="item">
                <h1><strong><img src="/image/experience.png" alt=""></strong>Experiences</h1>
            ...
            <div class="items">
                <h1><strong><img src="/image/etude.png" alt=""></strong>Education</h1>
                    ...
                    <div class="exp">
                        ...
                        <div class="exper">
                            <h3><?= $formations['etablissement'] ?> <em><?= $formations['moisDebut'] ?> /
                                                    ...
                                                    <p><?= $formations['Filiere'] ?>  <span class="titre"> <strong> <?= $formations['niveau'] ?></strong></span> </p>
            ...
            <div class="itemss">
                <h1><strong><img src="/image/compétences.png" alt=""></strong>Competences</h1>
            ...
            <div class="itemsss">
                <h1><strong><img src="/image/outil.png" alt=""></strong>Outis informatique</h1>
                    ...
                    <div class="exp">
                        ...
                        <div class="exper">
                            <h3><?= $formations['etablissement'] ?> <em><?= $formations['moisDebut'] ?> /
                                                    <?= $formations['anneeDebut'] ?> // <?= $formations['moisFin'] ?> /
                                                    <?= $formations['anneeFin'] ?></em> </h3>
                            <span class="titre">  <?= $formations['Filiere'] ?>  <strong> <?= $formations['niveau'] ?></strong></span>
